\section{Surveys of regex research}

\todoMid{clean these thoughts} We've got a handful of surveys that have been done exploring the state of the art in regex: Brzozowski in 1962 did the first survey of applications,
...
\section{Refactoring and smells}
