...
\begin{itemize} \setlength \itemsep{.1pt}
    ...
    \item Identification of 20 refined categories (Section~\ref{sec:20refinedCategories}) and an analysis of how frequently clusters belong to each and (Section~\ref{sec:refinedMembership}),
    \item An analysis of what features are most frequently observed for each refined category indicating an association with use cases (Section~\ref{sec:categoryFeatures}),
