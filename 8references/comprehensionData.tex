\chapter{Mechanical Turk Comprehension Study}
...
\begin{figure}[h]
   ...
   \begin{tabular}{@{}c@{\hspace{.2cm}}c@{}}
       \includegraphics[page=1,width=.5\textwidth]{nontex/MTtemplate} &
       \includegraphics[page=2,width=.5\textwidth]{nontex/MTtemplate} \\[.2cm]
       \includegraphics[page=3,width=.5\textwidth]{nontex/MTtemplate} &
       \includegraphics[page=4,width=.5\textwidth]{nontex/MTtemplate} \\[.2cm]
   \end{tabular}
