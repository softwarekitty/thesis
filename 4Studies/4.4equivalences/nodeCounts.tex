...
The source code used to perform the node counting process is available on GitHub\footurl{https://github.com/softwarekitty/regex_readability_study}.  Section~\ref{sec:nodeCountImplementation} provides implementation details sufficient to recreate the process.
