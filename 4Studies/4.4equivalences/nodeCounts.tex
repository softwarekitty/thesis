...
The implementation is written in Java 8, and depends on antlr 3.5.2 because the PCRE parser used\footurl{https://github.com/bkiers/pcre-parser} uses antlr to identify the features present in a pattern.  Implementation details about building the corpus can be found in Section~\ref{sec:corpusBuilding}.  For this experiment, the corpus was re-loaded from a text file.  Tests verify that this re-loaded corpus is identical to the corpus built from scratch.
