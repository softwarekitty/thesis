\begin{table}
\caption{Results of subtracting the average task frequency of ephemeral users from the average task frequency of persistent users, ordered by difference \label{tab:regexPersistingTasks}}
\begin{center}
\begin{small}
\begin{tabular}{l|ccc}
\toprule
